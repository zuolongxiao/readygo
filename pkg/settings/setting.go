...
func Load() {
	...
	MySQL.Port = viper.GetUint32("MySQL.Port")
	MySQL.User = viper.GetString("MySQL.User")
	MySQL.Password = viper.GetString("MySQL.Password")
	MySQL.Name = viper.GetString("MySQL.Name")
	MySQL.Charset = viper.GetString("MySQL.Charset")
	MySQL.MaxIdleConns = viper.GetInt("MySQL.MaxIdleConns")
	MySQL.MaxOpenConns = viper.GetInt("MySQL.MaxOpenConns")
	MySQL.ConnMaxLifetime = time.Duration(viper.GetUint64("MySQL.ConnMaxLifetime")) * time.Second
